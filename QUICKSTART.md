...
**Optional:** to have it start automatically at login and restart itself if it ever crashes, run `./install-launch-agent.sh` instead of starting it by hand. See [AUTOSTART.md](AUTOSTART.md) for what that does.
